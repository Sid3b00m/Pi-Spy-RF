...
> **Not only for Pi:** the same app runs on **Linux (Debian, Ubuntu, Fedora, RHEL, Arch, openSUSE, Alpine), macOS, and Windows** — in demo mode without SDR hardware. See [Install on any platform](docs/platforms.md) and [SECURITY.md](SECURITY.md).
